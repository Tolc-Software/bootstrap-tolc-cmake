...
def parseArguments():
    ...
    parser.add_argument(
        "--github-token", type=str, required=False, nargs='*', help="A token generated by github for accessing the repository",
    )
...
def main():
    ...
    if args.github_token != "":
        token = f"{args.github_token}:"

    url = f"https://{token}@api.github.com/repos/{args.user}/{args.repository}/releases"
